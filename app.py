...
def download_media(url: str, format_type: str) -> Tuple[str, str]:
    """Download media and return the path to the temp file and filename."""
    ydl_opts = {
...
def download():
    ...
    try:
        ...
        # Cleanup temporary files after serving the response
        def cleanup_temp_files():
            temp_file_path = f"/tmp/{video_data.name}"  # Assuming you have stored the filename
            try:
        ...
        # Call cleanup in a separate thread to avoid blocking
