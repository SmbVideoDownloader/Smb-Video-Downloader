...
def download_media(url: str, format_type: str) -> Tuple[str, str]:
    ...
    ydl_opts = {
        ...
        'postprocessors': [
            {
                ...
                'preferredcodec': 'aac',  # Ensure audio is re-encoded to AAC
                'preferredquality': '192',  # Optional: set the audio quality
            },
            {
        ...
        'overwrites': True  # Force yt-dlp to overwrite existing files
    }
