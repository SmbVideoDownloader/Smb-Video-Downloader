...
def download_media(url: str) -> Tuple[str, str]:
    ...
    video_id = None  # Initialize video_id for later use
    ...
    try:
        ...
        # Now we need to find the downloaded files
        video_file = f"/tmp/{video_id}.f303.webm"  # Adjust this as needed
        audio_file = f"/tmp/{video_id}.f251.webm"  # Adjust this as needed
