...
def download_media(url: str, format_type: str) -> Tuple[str, str]:
    ...
    ydl_opts = {
        ...
        'merge_output_format': 'mp4' if format_type == 'video' else 'mp3',  # Ensure final output format is mp4 or mp3
        'postprocessors': [
            {
            ...
            },
            {
                ...
                'preferredcodec': 'aac',  # Convert audio to AAC (which works with MP4)
                'preferredquality': '192',  # Set quality for the audio conversion
            },
            {
                'key': 'FFmpegEmbedSubtitle',  # Optional: if subtitles are needed
            },
        ],
